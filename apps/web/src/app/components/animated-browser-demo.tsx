...
export function AnimatedBrowserDemo() {
  return (
    <div className="relative mx-auto mt-5 w-full max-w-xl self-start lg:mt-10 xl:mt-12 2xl:max-w-2xl">
      <motion.div
        className="absolute -left-14 top-14 z-20 hidden rounded-2xl border border-cyan-300/20 bg-cyan-300/10 p-3 text-cyan-100 shadow-[0_0_50px_rgba(34,211,238,0.18)] md:block"
